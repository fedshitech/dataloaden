//go:generate go run github.com/fedshitech/dataloaden UserSliceLoader int []github.com/fedshitech/dataloaden/example.User
...
import (
	...
	"github.com/fedshitech/dataloaden/example"
)
