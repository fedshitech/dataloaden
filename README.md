...
Original Repository: https://github.com/vektah/dataloaden?tab=readme-ov-file
...
```bash
go run github.com/fedshitech/dataloaden UserLoader string *github.com/dataloaden/example.User
```
...
```bash
go run github.com/fedshitech/dataloaden UserSliceLoader string []*github.com/dataloaden/example.User
```
...
import _ "github.com/fedshitech/dataloaden"
```

This will allow go modules to see the dependency.

You can invoke it from anywhere within your module now using `go run github.com/fedshitech/dataloaden` and 
